...
{
    /// <summary>
    /// Keeps the App Service health probe out of Application Insights while it is succeeding.
    /// </summary>
    /// <remarks>
    /// <para>
    /// App Service calls the health check every minute, for ever. That is about 43,000 requests
    /// a month which are not traffic, on an account that is billed by the volume it ingests, and
    /// they drown the real request list: a chart of "requests over time" that is 99% probe tells
    /// you nothing about the dispatch office.
    /// </para>
    /// <para>
