        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientApp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    ...
                    RevokedReason = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RefreshTokens", x => x.Id);
                    table.CheckConstraint("CK_RefreshTokens_OneSubject", "([UserId] IS NOT NULL AND [CustomerId] IS NULL) OR ([UserId] IS NULL AND [CustomerId] IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokens_AbsoluteExpiresAtUtc",
                table: "RefreshTokens",
