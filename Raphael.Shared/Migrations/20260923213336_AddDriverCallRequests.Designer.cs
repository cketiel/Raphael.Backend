...
namespace Raphael.Shared.Migrations
{
    ...
    [Migration("20260923213336_AddDriverCallRequests")]
    partial class AddDriverCallRequests
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Raphael.Shared.Entities.CallRequests.DriverCallRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("DriverAvailableAtUtc")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime>("LastDriverSignalAtUtc")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("OperatingDate", "DriverId")
                    ...
                    b.ToTable("DriverCallRequests", (string)null);
                });

            modelBuilder.Entity("Raphael.Shared.Entities.CallRequests.DriverCallRequestEvent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("CallRequestId", "AtUtc")
                        .HasDatabaseName("IX_DriverCallRequestEvents_Request_At");

                    b.ToTable("DriverCallRequestEvents", (string)null);
                });
            ...
            modelBuilder.Entity("Raphael.Shared.Entities.GPS", b =>
                {
                    ...
                    b.HasIndex("IdVehicleRoute", "DateTime")
            ...
            modelBuilder.Entity("Raphael.Shared.Entities.RefreshToken", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("RefreshTokens", null, t =>
                        {
                            t.HasCheckConstraint("CK_RefreshTokens_OneSubject", "([UserId] IS NOT NULL AND [CustomerId] IS NULL) OR ([UserId] IS NULL AND [CustomerId] IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("Raphael.Shared.Entities.Schedule", b =>
                {
                    ...
                    b.Property<TimeSpan?>("EarlyArrivalWait")
                        .HasColumnType("time");
                    ...
                    b.HasIndex("VehicleRouteId", "Date")
                        .HasDatabaseName("IX_Schedules_Route_Date");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("VehicleRouteId", "Date"), new[] { "Sequence" });
            ...
            modelBuilder.Entity("Raphael.Shared.Entities.Trip", b =>
                {
                    ...
                    b.HasIndex("Date", "VehicleRouteId")
            ...
            modelBuilder.Entity("Raphael.Shared.Entities.CallRequests.DriverCallRequestEvent", b =>
                {
                    b.HasOne("Raphael.Shared.Entities.CallRequests.DriverCallRequest", "CallRequest")
                        .WithMany("Events")
            ...
            modelBuilder.Entity("Raphael.Shared.Entities.RefreshToken", b =>
                {
                    ...
                    b.HasOne("Raphael.Shared.Entities.User", "User")
                        .WithMany()
